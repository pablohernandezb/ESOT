utils::globalVariables(c("country_id", "country_text_id", "country_name", "year",
                          "v2x_regime", "v2clstown_osp", "v2clstown_osp_codelow", "v2clstown_osp_codehigh",
                         ...
                         "v2clstown_osp" ,         "v2clstown_osp_codelow" , "v2clstown_osp_codehigh" ,"reg_start_year"     ,    "reg_end_year" ,         

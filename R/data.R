...
#'
#' Country-year data on episodes of state ownership transformation.
#'
#' @format A country-year dataset (class "tibble::tbl_df") with corresponding
#'   to the full V-Dem data set of cases, with columns related to
#'   the ESOT coding. Key columns include:
#'
#' \describe{
#'     \item{country_id}{V-Dem numeric country identifier}
#'     \item{year}{Year}
#'     \item{v2clstown_osp}{State ownership of the economy (0=planned, 4=market)}
#'     \item{priv_ep}{Binary indicator for a privatization episode}
#'     \item{stat_ep}{Binary indicator for a statization episode}
#' }
#'

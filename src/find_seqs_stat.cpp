 ...
 * statization episodes (decreasing v2clstown_osp).
 *
...
//'
//[[Rcpp::export]]
NumericVector find_seqs_stat(NumericVector v,
                            NumericVector r,
                            NumericVector t,
  ...
  // (d[i] <= start_incl, i.e. negative change).
  for (size_t i = 0; i < d_len; i++) {
    ...
    //  - End of vector
    //  - Reach tolerance w/o another dec
    //  - Hit a NA
    //  - Increase > cum_turn
    //  - Revert to econ_type == 3 (return to market economy)
